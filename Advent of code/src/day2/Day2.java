...
public class Day2 {
	 public static void main(String args[]) {
	        String str = "1-14 b: bbbbbbbbbbbbbbbbbbb\r\n" + 
	...
	System.out.println(numberOfValidPasswords2(arr));
	        /*for (int i=0;i<arr.length;i++)
	        	System.out.println(i+":"+arr[i]);
	        System.out.println(arr.length);*/
	    }

	    public static int numberOfValidPasswords(String arr[]) {
	        int num=0;
	    ...
	    public static int numberOfValidPasswords2(String arr[]) {
	        int num=0;
	        ...
	        for (int i =0;i<arr.length;i++) {
	        	...
	        	for (int j=0;j<s.length;j++)
	        		System.out.println(s[j]);
	        	int lowerIndex= Integer.parseInt(s[0])-1;
	        	int upperIndex= Integer.parseInt(s[1])-1;
	        	char letter= s[2].charAt(0);
	        	String string= s[3];
	        	if (string.charAt(lowerIndex)!=string.charAt(upperIndex) && (string.charAt(lowerIndex)==letter || string.charAt(upperIndex)==letter))
	        		num++;
	        }
